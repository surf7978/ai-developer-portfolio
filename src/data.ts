...
export const PROJECTS: Project[] = [
  {
    ...
    iconName: "Terminal",
    demoUrl: "https://mnistcnn2-ujbeudyjy7kv49rdg7ynqs.streamlit.app/",
    achievement: {
      problem: "PyTorch CNN 손글씨 숫자 인식 분류 모델의 추론 과정 및 결과 시각화를 고도화하고, 캔버스 드로잉 입력 기반 실시간 인터랙션 데모 환경을 구축.",
      causeAnalysis: [
        "기존 신경망 모델의 추론 프로세스를 직관적인 반응형 대시보드 인터페이스 형태로 실시간 검증할 수 있는 서빙 앱 구현 필요."
      ],
      data: [
        "MNIST 데이터셋 기반 CNN 아키텍처 학습 파이프라인 정밀화.",
        "인퍼런스 레이턴시 최소화 및 99% 이상의 고정밀 분류 성과 확보."
      ],
      solution: [
        "PyTorch 기반 CNN 모델 서빙 및 Streamlit 캔버스 전처리 파이프라인 구현.",
        "사용자가 직접 그린 필기체를 실시간 텐서 변환하여 클래스별 확률 분포를 인터랙티브하게 시각화."
      ],
      result: [
        "Streamlit Cloud 실시간 앱 배포 완료 (mnistcnn2).",
        "클라우드 웹 환경에서 즉각 동작하는 실시간 컴퓨터 비전 데모 포트폴리오 완성."
      ],
      learned: "컴퓨터 비전 모델의 실시간 사용자 드로잉 입력 처리 및 최적화된 웹 데모 구축 역량을 강화했습니다."
    }
  },
  {
    id: "proj-mnist",
